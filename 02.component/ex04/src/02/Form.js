...
export default function Form() {
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <input id="name" name="name" type="text" value={ name } onChange={ (e) => { setName(e.target.value.substr(0, 10)) } }/>
            ...
            <input id="password" name="password" type="password" value={ password } onChange={ (e) => { setPassword(e.target.value.substr(0, 10))}} />

            <fieldset>
                <legend>성별</legend>
                <label>여</label> <input type="radio" name="gender" value={ "female" } checked={ gender === 'female' } onChange={ (e) => { setGender(e.target.value) }}/>
                <label>남</label> <input type="radio" name="gender" value={ "male" } checked={ gender === 'male' } onChange={ (e) => { setGender(e.target.value) }} />
            </fieldset>
            ...
            <textarea id='' name='selfDescription' value={selfDescription} onChange={ e => setSelfDescription(e.target.value)} />
